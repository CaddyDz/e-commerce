                    ...
                    <div class="row">
                        <div class="col">
                            <div class="accordion" id="faq-toggles">
                                <div class="card active">
                                    <div class="card-header">
                                        <button class="btn btn-link" data-toggle="collapse" data-target="#faq-toggles-1">Is the theme responsive and customizable?</button>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#faq-toggles-2">How long can I get theme updates for free?</button>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#faq-toggles-3">Is the support period extendable?</button>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#faq-toggles-4">Do you accept extra theme services?</button>
                                    </div>
